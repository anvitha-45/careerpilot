    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center space-x-2">
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Tailoring Agent & CAR/STAR Generator</h1>
      ...
      {loading ? (
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-slate-900 to-brand-950/20 border border-emerald-500/20 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 text-xs sm:text-sm text-emerald-300">
            <div className="flex items-center space-x-3">
              <ShieldCheck className="w-6 h-6 text-emerald-400 shrink-0" />
              <div>
                <div className="flex items-center space-x-2">
                  <span className="font-bold text-sm sm:text-base text-white">Strict Zero-Hallucination Verified</span>
                  <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-mono text-xs font-bold">
                    PASSED
                  </span>
                </div>
                <p className="text-slate-300 mt-0.5 text-xs sm:text-sm leading-relaxed">
            ...
            <button
              ...
              className="w-full md:w-auto inline-flex items-center justify-center space-x-2 px-5 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs sm:text-sm font-bold shadow-lg shadow-emerald-600/25 transition shrink-0 hover:scale-105 active:scale-95 disabled:opacity-50 text-center"
            >
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-xs sm:text-sm text-slate-400 bg-slate-900/60 p-3 rounded-lg border border-slate-800/60 leading-relaxed">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-xs sm:text-sm text-white font-medium bg-brand-950/30 p-3 rounded-lg border border-brand-900/40 leading-relaxed">
                        {bullet.tailored_bullet}
                      </p>
                    </div>
                  </div>

                  <div className="text-xs sm:text-sm text-slate-400 pt-1 flex flex-wrap items-center gap-1.5">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="self-start sm:self-auto inline-flex items-center space-x-1.5 px-3.5 py-2 rounded-lg bg-slate-800 hover:bg-slate-750 text-slate-200 text-xs sm:text-sm font-semibold border border-slate-700 transition shrink-0"
              >
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-slate-950 border border-slate-850 text-xs sm:text-sm text-slate-300 leading-relaxed whitespace-pre-line font-sans">
          ...
          <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-brand-950/40 via-slate-900 to-slate-900 border border-brand-900/40 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="font-bold text-white text-base">Assets Ready for Application</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:space-x-3 sm:gap-0 w-full sm:w-auto">
              <button
                onClick={handleDownloadPdf}
                disabled={downloadingPdf}
                className="flex-1 sm:flex-initial inline-flex items-center justify-center space-x-2 px-5 py-3 rounded-xl bg-slate-800 hover:bg-slate-750 text-brand-300 hover:text-white border border-slate-700 text-xs sm:text-sm font-semibold transition text-center"
              >
              ...
              <Link
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center space-x-2 px-6 py-3 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-xs sm:text-sm font-semibold shadow-lg shadow-brand-500/20 transition shrink-0 text-center"
              >
