          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              {tailoredResult.bullet_rewrites?.map((bullet, idx) => (
                <div
                  key={idx}
                  className="p-5 rounded-xl bg-slate-950 border border-slate-850 space-y-3"
                >
                  ...
                  <div className="text-[11px] text-slate-400 pt-1 flex items-center space-x-2">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-750 text-slate-200 text-xs font-semibold border border-slate-700 transition"
              >
            ...
            <div className="p-6 rounded-xl bg-slate-950 border border-slate-850 text-xs text-slate-300 leading-relaxed whitespace-pre-line font-sans">
