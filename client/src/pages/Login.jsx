...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-2xl p-5 sm:p-8 shadow-2xl relative z-10">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Welcome to CareerPilot</h2>
