    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Assessment Agent</h1>
        ...
        <button
          ...
          disabled={refreshing}
          className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-750 text-slate-200 text-xs sm:text-sm font-semibold border border-slate-700 transition self-start disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="md:col-span-2 p-4 sm:p-6 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between shadow-sm">
          ...
          <div className="mt-4 p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-xs sm:text-sm text-slate-300 flex items-center space-x-2">
        ...
        <div className="p-4 sm:p-6 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <h3 className="text-sm sm:text-base font-bold text-white">GitHub Public Signal</h3>
                <span className="text-xs sm:text-sm text-slate-400">@{github.username || 'connected'}</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800">
              <span className="text-xs text-slate-500 uppercase font-semibold">Total Stars</span>
              <div className="text-xl font-bold text-white mt-1">{github.stars_count || 0} ★</div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800">
              <span className="text-xs text-slate-500 uppercase font-semibold">Top Languages</span>
              <div className="text-xs sm:text-sm font-bold text-brand-300 mt-1 truncate">
        ...
        <div className="p-4 sm:p-6 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <h3 className="text-sm sm:text-base font-bold text-white">LeetCode Problem Solving</h3>
                <span className="text-xs sm:text-sm text-slate-400">@{leetcode.username || 'connected'}</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-2.5 pt-2">
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-center">
              <span className="text-xs text-emerald-400 uppercase font-bold">Easy</span>
              <div className="text-lg font-bold text-white mt-0.5">{leetcode.easy_solved || 0}</div>
            </div>
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-center">
              <span className="text-xs text-amber-400 uppercase font-bold">Medium</span>
              <div className="text-lg font-bold text-white mt-0.5">{leetcode.medium_solved || 0}</div>
            </div>
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-center">
              <span className="text-xs text-rose-400 uppercase font-bold">Hard</span>
              <div className="text-lg font-bold text-white mt-0.5">{leetcode.hard_solved || 0}</div>
            </div>
          </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <Link
            to="/profile"
            className="text-xs sm:text-sm font-semibold text-brand-400 hover:text-brand-300 self-start sm:self-auto transition"
          >
