...
export const ProductTourOfferModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div className="bg-slate-900 border border-slate-750 rounded-3xl max-w-xl w-full shadow-2xl overflow-hidden relative animate-in zoom-in-95 duration-200">
        {/* Glow ambient effect */}
        ...
        <div className="px-6 sm:px-8 py-3 space-y-2.5 relative z-10">
        ...
        <div className="p-6 sm:p-8 pt-5 bg-slate-950/70 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 relative z-10">
          <button
            onClick={dismissOffer}
