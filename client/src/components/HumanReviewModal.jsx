    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-3 sm:p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col animate-in fade-in zoom-in duration-200">
          ...
          <div className="flex items-center space-x-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                <h3 className="font-bold text-white text-base sm:text-lg truncate">Mandatory Human Review Gate</h3>
                <span className="px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 border border-amber-500/30 text-xs font-bold uppercase shrink-0">
                  HITL Checkpoint
                </span>
              </div>
        ...
        <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 overflow-y-auto flex-1">
          ...
          <div className="p-3.5 sm:p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-start space-x-3 text-amber-200 text-xs sm:text-sm leading-relaxed">
          ...
          {/* Staged Form Fields */}
          <div>
            <h4 className="text-xs sm:text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-xl divide-y divide-slate-850">
              {stagedFields.map((field, idx) => (
                <div key={idx} className="p-3 flex items-center justify-between text-xs sm:text-sm gap-2">
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">
              Verification Checklist
            </h4>
            <div className="space-y-2">
              {checklist.map((item, idx) => (
                <div key={idx} className="flex items-center space-x-2.5 text-xs sm:text-sm text-slate-300">
                  <div className="w-4.5 h-4.5 rounded bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0">
        ...
        <div className="bg-slate-850 p-4 border-t border-slate-800 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 shrink-0">
          {application.apply_url ? (
            <a
              ...
              className="inline-flex items-center justify-center space-x-2 px-4 py-2.5 sm:py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs sm:text-sm font-medium border border-slate-700 transition w-full sm:w-auto text-center"
            >
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center gap-2 sm:space-x-3 sm:gap-0 sm:ml-auto w-full sm:w-auto">
            <button
              ...
              className="px-4 py-2.5 sm:py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs sm:text-sm font-medium transition cursor-pointer text-center"
            >
              Close
            </button>
            <button
              ...
              className="inline-flex items-center justify-center space-x-2 px-4 sm:px-5 py-3 sm:py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs sm:text-sm font-semibold shadow-md shadow-emerald-500/20 transition disabled:opacity-50 cursor-pointer text-center"
            >
